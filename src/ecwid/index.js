const ecwidProducts =  `<div id="my-store-80971795"></div>
<div><script data-cfasync="false" type="text/javascript" src="https://app.ecwid.com/script.js?80971795&data_platform=code&data_date=2022-11-23" charset="utf-8"></script>
    <script type="text/javascript">
      ...
      xProductBrowser("categoriesPerRow=3","views=grid(20,3) list(60) table(60)","categoryView=grid","searchView=list","defaultProductId=504852545","id=my-store-80971795");
    </script>
</div>`